...
<body>
    ...
    <div class='content'>
        ...
        <div>
            ...
            <form action="<?php echo e(route('pagar')); ?>" method="POST" style="position:absolute;left:350px;top:350px;">
                <?php echo csrf_field(); ?>
            ...
            <div class=""><?php echo e(session('success')); ?></div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\mcope\OneDrive\Área de Trabalho\desenvolvimento de sistemas\Banco-DS1-PROJETO\resources\views/pagamentos.blade.php ENDPATH**/ ?>
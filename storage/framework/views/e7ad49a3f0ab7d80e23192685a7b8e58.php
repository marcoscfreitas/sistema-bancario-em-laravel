...
<head>
    ...
    <style>
        ...
        .content {
        margin-left: 600px; /* Largura da sidebar */
        }
        #extratoButton, #transferenciaButton, #pagamentoButton {
...
<body>
    ...
    <span class="header-account" style="font-size: 40px; position:absolute; left:500px">Número da Conta: <?php echo e($user->numero_Conta); ?></span><br><br><br>
    <div style= 'position:absolute; top:200px'><br><br><br><br><br><br><br>
    <span class="header-balance" style='font-size:40px'>Saldo: R$ <?php echo e($user->saldo); ?></span><br><br><br>
    <span class="header-limit" style='font-size:40px'>Limite: R$ <?php echo e($user->limite); ?></span>
    </div>
    </body><?php /**PATH /home/aluno/Downloads/Banco-DS1-PROJETO/resources/views/home.blade.php ENDPATH**/ ?>